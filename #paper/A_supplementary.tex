...
(known as the ``sample size" of the distribution)

If we would only need a few new flips to sway our beliefs, then our prior beliefs should be represented by a small k. If we would need a large number of new flips to sway us away from our prior beliefs about mu, then our prior beliefs are worth a very large k \cite{Kruschke_2015}
