...
Considering the previous, instead of eliminating information based on preliminary analysis, we proposed a set of models that are \textit{robust} against influential observations. Considering the flexibility of the Bayesian framework, the proposal of such models was a trivial task (see Table \ref{tab:models}).
%
%
%
\begin{figure}[!h]
