...
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.43]{lab_to_research.png}}]
	...
	The last step would be \textcolor{blue}{to select the most fitting model}, and we do it with the ITA,
	\begin{enumerate}
		%
	...
	Select models with information criteria,
	\begin{enumerate}
		%
...
%
%
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.40]{models_table.png}}]
	{Competing models}
	%
