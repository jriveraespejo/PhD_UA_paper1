...
%
%
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.38]{BetaProp_dist.pdf}}]
	{Probabilistic (causal) model}
		...
		\begin{column}{0.5\textwidth}
			...
			\begin{equ}
				...
				\begin{aligned} 
					...
					H^{T}_{i} \leftarrow & \; f(SI_{i}) \\
					%
					SI_{i} \leftarrow & \; f(HS_{i}, \textcolor{red}{A_{i}}, \textcolor{red}{E_{i}}, \textcolor{red}{PTA_{i}}, U_{i} ) \\ \\ \\
					%
					HS_{i} \leftarrow & \; f(U_{HS}) \\
					%
					A_{i} \leftarrow & \; f(U_{A}) \\
		...
		\begin{column}{0.5\textwidth}  
			...
			\begin{equ}
				...
				\begin{aligned} 
					...
					H^{T}_{i} & = \; \text{inv\_logit}( -SI_{i} ) \\
					%
					SI_{i} & = \; a_{i} + \alpha + \alpha_{HS[i]} + \textcolor{red}{\alpha_{E[i]}} \\ 
					%
					& \quad + \textcolor{red}{ \beta_{A, HS[i]} (A_{i} - \bar{A}) } + \textcolor{red}{\beta_{P} PTA_{i}} \\
					%
