...
%
%
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.43]{chains1.pdf}}]
...
%
%
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.43]{chains2.pdf}}]
	{``Health" of MCMC chains}
...
%
%
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.43]{chain_stat.pdf}}]
	{``Health" of MCMC chains}
...
%
%
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.43]{recovery.pdf}}]
	{Parameter recovery}
	{On idealized data}
...
%
%
\begin{lhframe}[rhgraphic={\includegraphics[scale=0.43]{posterior_predictive.pdf}}]
